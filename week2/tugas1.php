...
<body>
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="col-3">
                <ul class="list-group">
                    <li class="list-group-item active" aria-current="true"><h4>Daftar Harga</h4></li>
                    <li class="list-group-item">TV : 4.200.000</li>
                    <li class="list-group-item">Kulkas : 3.100.000</li>
                    <li class="list-group-item">Mesin Cuci : 3.800.000</li>
                    <li class="list-group-item active" aria-current="true"><i><p>*Harga dapat berubah sewaktu-waktu</p></i></li>               
                </ul>
            </div>
        </div>
    </div>
